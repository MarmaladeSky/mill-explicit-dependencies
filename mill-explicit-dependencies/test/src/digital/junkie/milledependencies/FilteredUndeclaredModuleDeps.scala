...
object FilteredUndeclaredModuleDeps extends TestRootModule {
  ...
  object app extends ScalaModule with ExplicitDependencies {
    ...
    // The filter suppresses the undeclared warning for core
    override def undeclaredCompileModulesFilter = Seq(core)
  }
