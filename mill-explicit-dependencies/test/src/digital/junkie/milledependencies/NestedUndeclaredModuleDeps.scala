...
object NestedUndeclaredModuleDeps extends TestRootModule {
  ...
  object app extends ScalaModule with ExplicitDependencies {
    def scalaVersion = "3.7.3"
    override def moduleDeps = Seq(outer.middle)
    // app uses core.CoreModel directly but does NOT declare outer.core in moduleDeps
  }
